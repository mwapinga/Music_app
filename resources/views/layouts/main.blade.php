                                             ...
                                             <!---->
                                              <div class="col-md-4 player">
                                                    <div class="audio-player">
                                                        ...
                                                        <source src="{{ asset('media/Blue Browne.ogg') }}" type="audio/ogg"></source>
                                                                <source src="{{ asset('media/Blue Browne.mp3') }}" type="audio/mpeg"></source>
                                                                <source src="{{ asset('media/Georgia.ogg') }}" type="audio/ogg"></source>
                                                                <source src="{{ asset('media/Georgia.mp3') }}" type="audio/mpeg"></source></audio>
                                                        </div>
                                                <!---->
